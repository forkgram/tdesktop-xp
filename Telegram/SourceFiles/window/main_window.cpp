...
constexpr auto XpBuildMark = "XP 6.9.4 #8 callbox";
namespace {
...
QImage GenerateCounterLayer(CounterLayerArgs &&args) {
	...
	const auto d = [&]() -> Dimensions {
		...
		case 16:
			return {
				16,
				((textSize < 2) ? 11 : (textSize < 3) ? 11 : 8),
				((textSize < 2) ? 5 : (textSize < 3) ? 2 : 1),
				((textSize < 2) ? 8 : (textSize < 3) ? 7 : 3),
			};
		case 20:
			return {
				20,
				((textSize < 2) ? 14 : (textSize < 3) ? 13 : 10),
				((textSize < 2) ? 6 : (textSize < 3) ? 2 : 1),
				((textSize < 2) ? 10 : (textSize < 3) ? 9 : 5),
			};
		case 24:
			return {
				24,
				((textSize < 2) ? 17 : (textSize < 3) ? 16 : 12),
				((textSize < 2) ? 7 : (textSize < 3) ? 3 : 1),
				((textSize < 2) ? 12 : (textSize < 3) ? 11 : 6),
			};
		default:
			return {
				32,
				((textSize < 2) ? 22 : (textSize < 3) ? 20 : 16),
				((textSize < 2) ? 9 : (textSize < 3) ? 4 : 2),
				((textSize < 2) ? 16 : (textSize < 3) ? 14 : 8),
			};
		}
	}();
...
, _screenReaderBar(Ui::CreateScreenReaderBar(body(), [=] {
	...
	args.text = tr::lng_screen_reader_confirm_text(tr::now);
	...
	args.confirmText = tr::lng_screen_reader_confirm_disable();
