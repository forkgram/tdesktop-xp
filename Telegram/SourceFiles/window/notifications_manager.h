...
private:
	...
	struct NotificationInHistoryKey {
		...
		friend inline bool operator==(NotificationInHistoryKey a, NotificationInHistoryKey b) { return (a.messageId == b.messageId) && (a.type == b.type); }
		friend inline bool operator!=(NotificationInHistoryKey a, NotificationInHistoryKey b) { return !(a == b); }
		friend inline bool operator<(NotificationInHistoryKey a, NotificationInHistoryKey b) { return (a.messageId < b.messageId) || ((a.messageId == b.messageId)) && (a.type < b.type); }
	};
	struct Timing {
		crl::time delay = 0;
		crl::time when = 0;
...
public:
	struct ContextId {
		...
		friend inline bool operator==(const ContextId &a, const ContextId &b) { return (a.sessionId == b.sessionId) && (a.peerId == b.peerId) && (a.topicRootId == b.topicRootId); }
		friend inline bool operator!=(const ContextId &a, const ContextId &b) { return !(a == b); }
		friend inline bool operator<(const ContextId &a, const ContextId &b) { return (a.sessionId < b.sessionId) || ((a.sessionId == b.sessionId)) && (a.peerId < b.peerId) || ((a.sessionId == b.sessionId) && (a.peerId == b.peerId)) && (a.topicRootId < b.topicRootId); }
	...
	struct NotificationId {
		...
		friend inline bool operator==(const NotificationId &a, const NotificationId &b) { return (a.contextId == b.contextId) && (a.msgId == b.msgId); }
		friend inline bool operator!=(const NotificationId &a, const NotificationId &b) { return !(a == b); }
		friend inline bool operator<(const NotificationId &a, const NotificationId &b) { return (a.contextId < b.contextId) || ((a.contextId == b.contextId)) && (a.msgId < b.msgId); }
