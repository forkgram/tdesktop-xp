...
void NativeManager::doShowNotification(NotificationFields &&fields) {
	...
	// XP walk: designated inits (C++20, C7555) -> positional; all 9 NotificationInfo
	// fields set in declared order (peer, topicRootId, monoforumPeerId, itemId, title,
	// subtitle, message, sound, options).
