...
// XP walk: designated -> positional (C7555). descriptor<bool>: id@0, name@1,
// description@2, defaultValue@3, scope@4, restartRequired@5.
base::options::toggle ClassicProfileScroll({
	kClassicProfileScroll, // id
	"Use classic profile scroll processing.", // name
	"Reverts the profile cover scroll to the previous "
		"(filler-based) implementation.", // description
	false, // defaultValue (bool())
	base::options::windows | base::options::macos | base::options::linux, // scope (default)
