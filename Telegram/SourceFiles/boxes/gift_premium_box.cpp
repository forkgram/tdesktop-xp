...
void GiftBox(
	...
	tr::lng_premium_gift_about(
		...
		raw->setMarkedText(t, Core::MarkedTextContext{ session } /* XP walk: positional */);
	}, textLabel->lifetime());
...
void GiftsBox(
	...
	// About.
	{
		...
		std::move(
			...
			label->setMarkedText(t, MarkedTextContext{ session } /* XP walk: designated -> positional (C7555); MarkedTextContext::session */);
		}, label->lifetime());
