...
void BuildNotificationsReactionsContent(SectionBuilder &builder) {
	...
	builder.addSubsectionTitle({
		u"notifications/reactions/about"_q, // id
		tr::lng_notification_reactions_notify_about(), // title
	});
	...
	builder.add([](const WidgetContext &ctx) {
		...
		return SearchEntry{
			u"notifications/reactions/messages"_q, // id
			tr::lng_notification_reactions_messages_full(tr::now), // title
			{ u"reactions"_q, u"messages"_q }, // keywords
		};
	});
	...
	builder.addSkip(st::settingsCheckboxesSkip);
	builder.addSubsectionTitle({
		u"notifications/reactions/settings"_q, // id
		tr::lng_notification_reactions_settings(), // title
	});
	...
	builder.add([](const WidgetContext &ctx) {
		...
		return SearchEntry{
			u"notifications/reactions/preview"_q, // id
			tr::lng_notification_reactions_show_sender(tr::now), // title
			{ u"sender"_q, u"preview"_q }, // keywords
		};
	});
}

const auto kMeta = BuildHelper({
	NotificationsReactions::Id(), // id
	NotificationsId(), // parentId
	&tr::lng_notification_reactions, // title
	&st::menuIconGroupReactions, // icon
