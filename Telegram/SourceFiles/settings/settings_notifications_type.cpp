...
void SetupChecks(
	...
	sound->toggledValue(
		...
		const auto value = Data::NotifySound{
			{}, // title
			{}, // data
			{}, // id
			!enabled, // none
...
void SetupExceptions(
	...
	wrap->entity()->setClickedCallback([=] {
		...
		window->show(Ui::MakeConfirmBox({
			tr::lng_notification_exceptions_clear_sure(), // text
			clear, // confirmed
			{}, // cancelled
			tr::lng_notification_exceptions_clear_button(), // confirmText
			{}, // cancelText
			...
			{}, // labelFilter
			{}, // labelPadding
			tr::lng_notification_exceptions_clear(), // title
		}));
	});
	wrap->toggleOn(
