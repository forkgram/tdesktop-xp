...
private:
	...
	struct GroupRequestKey {
		...
		friend inline bool operator==(GroupRequestKey a, GroupRequestKey b) { return (a.history == b.history) && (a.rootId == b.rootId); }
		friend inline bool operator!=(GroupRequestKey a, GroupRequestKey b) { return !(a == b); }
		friend inline bool operator<(GroupRequestKey a, GroupRequestKey b) { return (a.history.get() < b.history.get()) || ((a.history == b.history) && (a.rootId < b.rootId)); }
	};
