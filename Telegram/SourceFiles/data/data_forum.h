...
struct ForumOffsets {
	...
	friend inline bool operator==(ForumOffsets a, ForumOffsets b) { return (a.date == b.date) && (a.id == b.id) && (a.topicId == b.topicId); }
	friend inline bool operator!=(ForumOffsets a, ForumOffsets b) { return !(a == b); }
	friend inline bool operator<(ForumOffsets a, ForumOffsets b) { return (a.date < b.date) || ((a.date == b.date)) && (a.id < b.id) || ((a.date == b.date) && (a.id == b.id)) && (a.topicId < b.topicId); }
};
