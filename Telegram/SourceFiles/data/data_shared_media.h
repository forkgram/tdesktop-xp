...
public:
	...
	struct Key {
		...
		friend inline constexpr bool operator==(const Key &a, const Key &b) { return (a.peerId == b.peerId) && (a.topicRootId == b.topicRootId) && (a.migratedPeerId == b.migratedPeerId) && (a.type == b.type) && (a.universalId == b.universalId); }
		friend inline constexpr bool operator!=(const Key &a, const Key &b) { return !(a == b); }
		friend inline constexpr bool operator<(const Key &a, const Key &b) { return (a.peerId < b.peerId) || ((a.peerId == b.peerId)) && (a.topicRootId < b.topicRootId) || ((a.peerId == b.peerId) && (a.topicRootId == b.topicRootId)) && (a.migratedPeerId < b.migratedPeerId) || ((a.peerId == b.peerId) && (a.topicRootId == b.topicRootId) && (a.migratedPeerId == b.migratedPeerId)) && (a.type < b.type) || ((a.peerId == b.peerId) && (a.topicRootId == b.topicRootId) && (a.migratedPeerId == b.migratedPeerId) && (a.type == b.type)) && (a.universalId < b.universalId); }
