...
struct MessageGroupId {
	...
	friend inline constexpr bool operator==(MessageGroupId a, MessageGroupId b) noexcept { return a.value == b.value; }
	friend inline constexpr bool operator!=(MessageGroupId a, MessageGroupId b) noexcept { return a.value != b.value; }
	friend inline constexpr bool operator<(MessageGroupId a, MessageGroupId b) noexcept { return a.value < b.value; }
	friend inline constexpr bool operator>(MessageGroupId a, MessageGroupId b) noexcept { return a.value > b.value; }
	friend inline constexpr bool operator<=(MessageGroupId a, MessageGroupId b) noexcept { return a.value <= b.value; }
...
struct ForwardDraft {
	...
	// XP walk: defaulted <=> (C7589, C++20) -> manual ==/!=.
	friend inline bool operator==(
			const ForwardDraft &a,
			const ForwardDraft &b) {
		return (a.ids == b.ids) && (a.options == b.options);
	}
	friend inline bool operator!=(
			const ForwardDraft &a,
			const ForwardDraft &b) {
