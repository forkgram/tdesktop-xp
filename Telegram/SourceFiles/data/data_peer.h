...
struct AllowedReactions {
	...
	// XP walk: removed C++20 defaulted friend operator== (C7589); it was also
	// ambiguous with the free operator== below. Comparison uses the free
	// operator</==/!= declared below, defined in data_peer.cpp.
};
...
private:
	...
	// XP walk: bit-fields dropped (C7582); took theirs (+_colorProfileIndex).
	uint8 _colorIndex = 0;
