...
public:
	...
	struct Key {
		...
		friend inline constexpr bool operator==(const Key &a, const Key &b) { return (a.peerId == b.peerId) && (a.topicRootId == b.topicRootId) && (a.migratedPeerId == b.migratedPeerId) && (a.universalId == b.universalId); }
