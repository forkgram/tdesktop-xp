...
void GroupCall::ensureControllerCreated() {
	...
	tgcalls::GroupInstanceDescriptor descriptor = {
		nullptr, // threads -- StaticThreads is not built under DISABLE_WEBRTC
		tgcalls::GroupConfig{
		},
		...
		nullptr, // onAudioFrame (field 5, skipped by upstream)
		_audioInputId.toStdString(),
		_audioOutputId.toStdString(),
		true, // useDummyChannel (field 8, v2.7.2 replaced debugIgnoreMissingSsrcs)
		false, // disableIncomingChannels (field 9, v2.7.2)
		nullptr, // createAudioDeviceModule (field 10, WebRTC disabled on XP)
		nullptr, // videoCapture (field 11, skipped)
		nullptr, // incomingVideoSourcesUpdated (field 12, skipped)
		[=](
