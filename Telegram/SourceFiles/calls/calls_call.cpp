...
// XP walk: keep the WebRTC-disabled guard (InstanceImpl* don't compile without
// WebRTC); take theirs -- v5.14.0 dropped RegisterV240/RegisterLegacy (types gone).
...
void Call::createAndStartController(const MTPDphoneCall &call) {
	...
	tgcalls::Descriptor descriptor = {
		...
		{}, // audioLevelUpdated
		[=](bool isLow) { // remoteBatteryLevelIsLowUpdated (XP walk: designated -> positional)
#ifdef _DEBUG
//			isLow = true;
#endif
			crl::on_main(weak, [=] {
