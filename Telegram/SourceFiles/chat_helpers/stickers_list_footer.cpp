...
void StickersListFooter::mousePressEvent(QMouseEvent *e) {
	...
	} else if (_selected == OverState(SpecialOver::Search)) {
		toggleSearch(true);
	} else {
		_pressed = _selected;
