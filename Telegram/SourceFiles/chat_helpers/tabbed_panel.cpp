...
base::options::toggle TabbedPanelShowOnClick({ kOptionTabbedPanelShowOnClick, "Show tabbed panel by click", "Show Emoji / Stickers / GIFs panel only after a click." });
...
: TabbedPanel(parent, {
	...
	{ nullptr }, // ownedSelector
	selector, // nonOwnedSelector
}) {
}
...
: TabbedPanel(parent, {
	controller, // regularWindow
	std::move(selector), // ownedSelector
}) {
}
