...
private:
	...
	struct NotifySettingsKey {
		...
		friend inline constexpr bool operator==(NotifySettingsKey a, NotifySettingsKey b) { return (a.peerId == b.peerId) && (a.topicRootId == b.topicRootId); }
		friend inline constexpr bool operator!=(NotifySettingsKey a, NotifySettingsKey b) { return !(a == b); }
		friend inline constexpr bool operator<(NotifySettingsKey a, NotifySettingsKey b) { return (a.peerId < b.peerId) || ((a.peerId == b.peerId) && (a.topicRootId < b.topicRootId)); }
	};
	...
	struct SharedMediaRequest {
		...
		friend inline bool operator==(const SharedMediaRequest &a, const SharedMediaRequest &b) { return (a.mediaType == b.mediaType) && (a.aroundId == b.aroundId) && (a.sliceType == b.sliceType); }
		friend inline bool operator!=(const SharedMediaRequest &a, const SharedMediaRequest &b) { return !(a == b); }
		friend inline bool operator<(const SharedMediaRequest &a, const SharedMediaRequest &b) {
