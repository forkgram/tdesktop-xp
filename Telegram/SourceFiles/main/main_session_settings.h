...
private:
	...
	struct ThreadId {
		...
		friend inline constexpr bool operator==(ThreadId a, ThreadId b) { return (a.peerId == b.peerId) && (a.topicRootId == b.topicRootId); }
		friend inline constexpr bool operator!=(ThreadId a, ThreadId b) { return !(a == b); }
		friend inline constexpr bool operator<(ThreadId a, ThreadId b) { return (a.peerId < b.peerId) || ((a.peerId == b.peerId) && (a.topicRootId < b.topicRootId)); }
	};
