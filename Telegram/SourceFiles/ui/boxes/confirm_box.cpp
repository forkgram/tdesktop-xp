...
// XP walk: take theirs - new upstream IconWithTitle helper (declared in
// confirm_box.h, used by window_peer_menu). HEAD note is obsolete:
// MakeInformBox(v::text::data) is already inline in the header.
void IconWithTitle(
