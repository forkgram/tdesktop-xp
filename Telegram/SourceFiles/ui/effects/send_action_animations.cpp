...
public:
	...
	, _eye({
		float64(st::historySendActionChooseStickerEyeWidth),
		float64(st::historySendActionChooseStickerEyeHeight),
		float64(st::historySendActionChooseStickerEyeStep),
		style::ConvertScale(1.5),
		-style::ConvertScale(2.5)
			+ st::historySendActionChooseStickerEyeWidth,
		style::ConvertScale(1.5),
		style::ConvertScale(0.8 * 1.3),
		style::ConvertScale(1.2 * 1.3),
