...
struct ChatPaintContext {
	...
	-> std::optional<Ui::Text::HighlightInfoRequest> {
		...
		return Ui::Text::HighlightInfoRequest{
			// XP walk: designated -> positional (C7555). range, interpolateTo,
			// interpolateProgress, outPath.
			highlight.range, // range
			highlightInterpolateTo, // interpolateTo
			(1. - highlight.collapsion), // interpolateProgress
			highlightPathCache, // outPath
		};
	};
...
public:
	...
	[[nodiscard]] gsl::span<Text::SpecialColor> highlightColors() const;
