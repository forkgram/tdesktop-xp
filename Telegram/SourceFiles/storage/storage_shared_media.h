...
struct SharedMediaKey {
	...
	friend inline constexpr bool operator==(const SharedMediaKey &a, const SharedMediaKey &b) { return (a.peerId == b.peerId) && (a.topicRootId == b.topicRootId) && (a.type == b.type) && (a.messageId == b.messageId); }
	friend inline constexpr bool operator!=(const SharedMediaKey &a, const SharedMediaKey &b) { return !(a == b); }
	friend inline constexpr bool operator<(const SharedMediaKey &a, const SharedMediaKey &b) { return (a.peerId < b.peerId) || ((a.peerId == b.peerId) && (a.topicRootId < b.topicRootId)) || ((a.peerId == b.peerId) && (a.topicRootId == b.topicRootId) && (a.type < b.type)) || ((a.peerId == b.peerId) && (a.topicRootId == b.topicRootId) && (a.type == b.type) && (a.messageId < b.messageId)); }
...
private:
	struct Key {
		...
		friend inline constexpr bool operator==(Key a, Key b) { return (a.peerId == b.peerId) && (a.topicRootId == b.topicRootId); }
		friend inline constexpr bool operator!=(Key a, Key b) { return !(a == b); }
		friend inline constexpr bool operator<(Key a, Key b) { return (a.peerId < b.peerId) || ((a.peerId == b.peerId) && (a.topicRootId < b.topicRootId)); }
	};
