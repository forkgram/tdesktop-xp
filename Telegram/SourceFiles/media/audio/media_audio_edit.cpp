...
[[nodiscard]] AudioEditResult TrimAudioToRange(
	...
	auto inputWrap = ReadBytesWrap{
		content.size(), // size
		0, // offset
		reinterpret_cast<const uchar*>(content.constData()), // data
	};
...
[[nodiscard]] AudioEditResult ConcatAudio(
	...
	auto firstWrap = ReadBytesWrap{
		first.size(), // size
		0, // offset
		reinterpret_cast<const uchar*>(first.constData()), // data
	};
	...
	auto secondWrap = ReadBytesWrap{
		second.size(), // size
		0, // offset
		reinterpret_cast<const uchar*>(second.constData()), // data
	};
