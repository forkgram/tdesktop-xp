...
void Application::showOpenGLCrashNotification() {
	...
	_primaryWindow->show(Ui::MakeConfirmBox({ ""
		...
		"or keep it disabled if crashes continue.", enable, keepDisabled, "Enable", "Keep Disabled" }));
}
...
void Application::forceLogOut(
	...
	const auto box = Ui::show(Ui::MakeConfirmBox({ explanation, {}, {}, tr::lng_passcode_logout(tr::now), {}, {}, {}, {}, {}, true }));
