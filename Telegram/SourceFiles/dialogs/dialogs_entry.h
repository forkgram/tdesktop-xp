...
struct BadgesState {
	...
	friend inline bool operator==(BadgesState a, BadgesState b) { return (a.unreadCounter == b.unreadCounter) && (a.unread == b.unread) && (a.unreadMuted == b.unreadMuted) && (a.mention == b.mention) && (a.mentionMuted == b.mentionMuted) && (a.reaction == b.reaction) && (a.reactionMuted == b.reactionMuted); }
	friend inline bool operator!=(BadgesState a, BadgesState b) { return !(a == b); }
