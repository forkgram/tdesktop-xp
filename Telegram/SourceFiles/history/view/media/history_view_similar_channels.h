...
private:
	...
	struct Channel {
		...
		// XP walk: bitfields ':N' dropped (C++17, C7582); keep uint32 storage
		uint32 more = 0;
		mutable uint32 moreLocked = 0;
		mutable uint32 subscribed = 0;
		mutable uint32 counterBgValid = 0;
	};
	...
	// XP walk: bitfields ':N' dropped (C++17, C7582); keep uint32 storage
	uint32 _titleWidth = 0;
	mutable uint32 _moreThumbnailsValid = 0;
	uint32 _viewAllWidth = 0;
	uint32 _fullWidth = 0;
	uint32 _empty = 0;
	mutable uint32 _toggled = 0;
	uint32 _scrollLeft = 0;
	uint32 _scrollMax = 0;
	uint32 _hasViewAll = 0;
	mutable uint32 _hasHeavyPart = 0;
