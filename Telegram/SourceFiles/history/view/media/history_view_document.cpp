...
[[nodiscard]] HistoryView::TtlPaintCallback CreateTtlPaintCallback(
	...
	state->start = Lottie::MakeIcon({ // XP walk: designated -> positional (C7555)
		u"voice_ttl_start"_q, // name
		{}, // path
		{}, // json
		&st::historyFileInIconFg, // color
	...
	animateSingle(
		state->start.get(),
		[=] {
			state->idle = Lottie::MakeIcon({ // XP walk: designated -> positional (C7555)
				u"voice_ttl_idle"_q, // name
				{}, // path
				{}, // json
				&st::historyFileInIconFg, // color
				iconSize, // sizeOverride
