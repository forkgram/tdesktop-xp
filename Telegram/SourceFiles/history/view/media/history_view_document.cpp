...
void Document::draw(
	...
	if (thumbed) {
		...
		const auto args = Images::PrepareArgs{ {}, (inWebPage
				? Images::Option::RoundSmall
				: Images::Option::RoundLarge), QSize(st.thumbSize, st.thumbSize) };
		QPixmap thumb;
...
bool DrawThumbnailAsSongCover(
	...
	const auto args = Images::PrepareArgs{ &colored, Images::Option::RoundCircle, rect.size() };
