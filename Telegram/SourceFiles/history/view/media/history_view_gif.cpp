...
, _thumbCacheRoundRadius(0)
, _thumbCacheRoundCorners(0)
, _thumbCacheBlurred(0) {
...
void Gif::drawGrouped(
	...
	if (streamed) {
		...
		auto request = ::Media::Streaming::FrameRequest{ pixSize * cIntRetinaFactor(), geometry.size() * cIntRetinaFactor(), roundRadius, corners };
