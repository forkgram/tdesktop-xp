...
: _sublist(sublist) {
	...
	_list.setAroundPosition({ // XP walk: designated -> positional (C7555)
		FullMsgId(selfId, ShowAtUnreadMsgId), // fullId
		TimeId(0), // date
	});
}
...
, _cornerButtons(
	...
	_topBar->setActiveChat(
		TopBarWidget::ActiveChat{ // XP walk: designated -> positional (C7555)
			sublist, // key
			Dialogs::EntryState::Section::SavedSublist, // section
		},
		nullptr);
